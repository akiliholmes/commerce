...
class Listings(models.Model):
    ...
    categories = models.ForeignKey(Categories, on_delete=models.CASCADE, related_name="category_list")
...
class Comment(models.Model):
    ...
    listing = models.ForeignKey(Listings, on_delete=models.CASCADE, related_name="listing_review")
